...
@Component({
  ...
  imports: [ViewPanel, MatFormField, MatLabel, FormsModule, MatInput, MatSelect, MatButton, MatOption , ReactiveFormsModule],
  template: `
    <div appViewPanel>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          ...
          <mat-form-field>
            <mat-select formControlName="rating">
              @for (option of ratingOption(); track option.value) {
